...
// descendant atomically — required because the claude CLI may fork
// helper processes (shell wrappers, MCP servers' children) that
// inherit stdout, keeping the pipe open even after the leader exits.
