...
// descendant atomically — the gemini CLI is a Node.js process that
// may fork MCP server children and shell helpers that inherit stdout,
// keeping the pipe open even after the leader exits.
