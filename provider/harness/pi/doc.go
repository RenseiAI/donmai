...
// pi/interactive/tool-lifecycle-v5; v2 introduced this local channel, v3
// added tool-plugin delivery, and v4/v5 register successively complete
// downstream realization surfaces per the adapter-version rule,
