...
// pi/interactive/tool-lifecycle-v6; v2 introduced this local channel, v3
// added tool-plugin delivery, v4/v5 register successively complete
// downstream realization surfaces, and v6 binds applied common config
// evidence per the adapter-version rule,
