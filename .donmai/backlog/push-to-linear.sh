...
create_issue "AF-012: Implement af agent stop subcommand" "Stop a running agent session by identifier. af agent stop OPS-674. Send graceful shutdown signal. Requires REDIS_URL." "migration"
...
create_issue "AF-014: Implement af agent chat subcommand" "Send a message to a running agent. af agent chat OPS-674 'message'. Uses forward-prompt API." "migration"
...
create_issue "AF-060: Implement af linear get-issue subcommand" "Get issue details by identifier. af linear get-issue OPS-674. Output: title, status, assignee, labels, description. Requires LINEAR_API_KEY." "migration"
...
create_issue "AF-063: Implement af linear update-issue subcommand" "Update issue fields. af linear update-issue OPS-674 --status 'In Progress' --assignee 'user'." "migration"
